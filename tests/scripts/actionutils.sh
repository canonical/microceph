...
function remote_configure_cephfs_mirroring() {
    ...
    mkdir /mnt/primary/dir1
    mkdir /mnt/primary/dir2
    echo $STR1 >> /mnt/primary/dir1/test_file
    echo $STR1 >> /mnt/primary/dir2/test_file
    ...
    # take snapshots
    mkdir /mnt/primary/dir1/.snap/two-snap
    mkdir /mnt/primary/dir2/.snap/two-snap
    sleep 20s
}
