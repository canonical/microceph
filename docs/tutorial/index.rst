...
You can expect to spend ten to fifteen minutes working through the complete
tutorial. It’s a strongly-recommended investment of time if you’re new to
Microceph. Follow the tutorial steps in sequence; they take you on a learning
...
`get support <https://github.com/canonical/microceph/issues>`_.
