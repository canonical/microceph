...
For detailed documentation of what keys should be configured, visit the `upstream Ceph documentation on RGW Keystone configuration`_.

.. LINKS

.. _Openstack Keystone: https://docs.openstack.org/keystone/latest/getting-started/architecture.html#identity
.. _upstream Ceph documentation on RGW Keystone configuration: https://docs.ceph.com/en/latest/radosgw/keystone/
