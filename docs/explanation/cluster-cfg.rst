...
In a multinode microceph cluster, restarting the daemons is done cautiously in a syncronous manner to prevent cluster outage. The flow diagram below explains the order of execution.
