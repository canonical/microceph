...
rgw frontends = beast{{if or (ne .rgwPort 0) (not .sslCertificateConfigKey) (not .sslPrivateKeyConfigKey)}} port={{.rgwPort}}{{end}}{{if and .sslCertificateConfigKey .sslPrivateKeyConfigKey}} ssl_port={{.sslPort}} ssl_certificate={{.sslCertificateConfigKey}} ssl_private_key={{.sslPrivateKeyConfigKey}}{{end}}
`)),
