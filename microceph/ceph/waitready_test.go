...
type waitreadySuite struct {
	tests.BaseSuite
}

func TestWaitready(t *testing.T) {
	suite.Run(t, new(waitreadySuite))
}

func (s *waitreadySuite) SetupTest() {
	s.BaseSuite.SetupTest()
}

func (s *waitreadySuite) TestWaitForCephReadyRetriesThenSucceeds() {
...
func (s *waitreadySuite) TestWaitForCephReadyTimeout() {
	r := mocks.NewRunner(s.T())
...
func (s *waitreadySuite) TestWaitForCephReadyImmediateSuccess() {
	r := mocks.NewRunner(s.T())
