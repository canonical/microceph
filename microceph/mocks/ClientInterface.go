...
// PutOsds provides a mock function with given fields: _a0, _a1, _a2
func (_m *ClientInterface) PutOsds(_a0 *client.Client, _a1 bool, _a2 string) error {
	ret := _m.Called(_a0, _a1, _a2)

	if len(ret) == 0 {
		panic("no return value specified for PutOsds")
	}

	var r0 error
	if rf, ok := ret.Get(0).(func(*client.Client, bool, string) error); ok {
		r0 = rf(_a0, _a1, _a2)
	} else {
		r0 = ret.Error(0)
	}
