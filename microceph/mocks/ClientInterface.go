...
func (_m *ClientInterface) DeleteClusterMember(_a0 mcTypes.Client, _a1 string, _a2 bool) error {
	ret := _m.Called(_a0, _a1, _a2)

	var r0 error
	if rf, ok := ret.Get(0).(func(mcTypes.Client, string, bool) error); ok {
		r0 = rf(_a0, _a1, _a2)
	} else {
		r0 = ret.Error(0)
	}
...
func (_m *ClientInterface) DeleteService(_a0 mcTypes.Client, _a1 string, _a2 string) error {
	ret := _m.Called(_a0, _a1, _a2)

	var r0 error
	if rf, ok := ret.Get(0).(func(mcTypes.Client, string, string) error); ok {
		r0 = rf(_a0, _a1, _a2)
	} else {
		r0 = ret.Error(0)
	}
...
func (_m *ClientInterface) GetClusterMembers(_a0 mcTypes.Client) ([]string, error) {
	...
	var r0 []string
	var r1 error
	if rf, ok := ret.Get(0).(func(mcTypes.Client) ([]string, error)); ok {
		return rf(_a0)
	}
	if rf, ok := ret.Get(0).(func(mcTypes.Client) []string); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]string)
...
func (_m *ClientInterface) GetDisks(_a0 mcTypes.Client) (types.Disks, error) {
	ret := _m.Called(_a0)

	var r0 types.Disks
	var r1 error
	if rf, ok := ret.Get(0).(func(mcTypes.Client) (types.Disks, error)); ok {
		return rf(_a0)
	}
	if rf, ok := ret.Get(0).(func(mcTypes.Client) types.Disks); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
...
func (_m *ClientInterface) GetServices(_a0 mcTypes.Client) (types.Services, error) {
	ret := _m.Called(_a0)

	var r0 types.Services
	var r1 error
	if rf, ok := ret.Get(0).(func(mcTypes.Client) (types.Services, error)); ok {
		return rf(_a0)
	}
	if rf, ok := ret.Get(0).(func(mcTypes.Client) types.Services); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
