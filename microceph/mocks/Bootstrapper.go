...
func (_m *Bootstrapper) Bootstrap(ctx context.Context, state interfaces.StateInterface) error {
...
func (_m *Bootstrapper) Precheck(ctx context.Context, state interfaces.StateInterface) error {
	ret := _m.Called(ctx, state)
