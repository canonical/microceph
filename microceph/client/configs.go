...
func SetConfig(ctx context.Context, c mcTypes.Client, data *types.Config) error {
...
func ClearConfig(ctx context.Context, c mcTypes.Client, data *types.Config) error {
	queryCtx, cancel := context.WithTimeout(ctx, time.Second*200)
	defer cancel()
...
func GetConfig(ctx context.Context, c mcTypes.Client, data *types.Config) (types.Configs, error) {
