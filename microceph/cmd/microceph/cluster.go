...
func (c *cmdCluster) Command() *cobra.Command {
	...
	// Bootstrap Ceph (CE142)
	clusterBootstrapCephCmd := cmdClusterBootstrapCeph{common: c.common, cluster: c}
	cmd.AddCommand(clusterBootstrapCephCmd.Command())
	...
	clusterMaintenance := cmdClusterMaintenance{common: c.common}
	cmd.AddCommand(clusterMaintenance.Command())
